.\bin\Release\WebTests.exe --url=http://www.hearthpwn.com/packs/simulator/1-hearthpwn-wild-pack -r -m --min=56 -e --max=100000 --delay=2250 --user={userName} --password={password} --cardSet=Wild
